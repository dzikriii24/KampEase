...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Kamp-Ease</title>
    <title>Leaflet Map dengan Routing ke WiFi Spot</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
<body>
    ...
    <!-- FITUR -->
    <div class="mt-10 poppins-bold grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 sm:px- lg:px-20 sm:mt-20 mt-10 justify-self-center gap-4 sm:gap-[50px]">
        <a href="">
    ...
    <footer class="bg-[#A78BFA] mt-10 pb-10">
