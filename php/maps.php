...
<body class="min-h-screen flex flex-col items-center justify-start">
    <!-- MAPS & DESKRIPSI -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-7xl px-4 py-8">
        <div class="relative">
        ...
        <div>
            <div class="md:col-span-1 w-[300px]" id="info-panel">
                <h2 class="poppins-bold text-2xl text-[#1F2937] md:text-3xl">
                    Detail Tempat
                </h2>
            </div>
        </div>
