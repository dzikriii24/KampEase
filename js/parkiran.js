        ...
        fetch("../php/getData.php?type=parkiran")
            ...
            .then(data => {
                data.forEach(parkiran => {
                    ...
                    marker.on("click", () => {
                        ...
                        const fotoParkiran = parkiran.foto && parkiran.foto.trim() !== "" ? parkiran.foto : "../images/parkings.png";
                        document.getElementById("info-panel").innerHTML = `
                            ...
                            <dialog id="foto" class="modal">
                                <div class="modal-box w-auto max-w-[400px] p-0 overflow-hidden">
                                    ...
                                    <img src="${fotoParkiran}" alt="Gambar"
                            ...
                            <div class="mt-2 rounded-lg p-4 poppins-regular" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                                <dl>
                                    <div>
                                        <dd class="font-medium">${parkiran.nama_parkiran}</dd>
                                    </div>
                                    <div>
                                        <p class="text-[12px] text-gray-500 w-full">Koordinat</p>
                                        <p class="text-[12px] text-gray-500 w-full">${parkiran.koordinat_lat}, ${parkiran.koordinat_lng}</p>
                                    </div>
                                </dl>
                                ...
                                <div class="mt-6 flex items-center gap-8 text-xs">
                                    <div class="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
                                        ...
                                        <div class="mt-1.5 sm:mt-0">
                                            <p class="text-[#1F2937]">Nama Parkiran</p>

                                            <p class="font-lg nunito-regular text-gray-500">${parkiran.nama_parkiran}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5 sm:mt-3 gap-8 text-xs">

                                    <p class="text-[#1F2937] mt-3">deskripsi</p>

                                    <p class="font-lg nunito-regular text-gray-500">${parkiran.deskripsi}</p>


                                    <p class=""><a href='${parkiran.link_maps}' class="text-blue-500 hover:text-blue-700 popins-regular">
                                            Pergi Sekarang
                                        </a></p>
                                </div>
                            </div>
